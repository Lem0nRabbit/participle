...
public class ParticipleApplication {

    public static void main(String[] args) {

        Dictionary publicDictionary = Dictionary.builder()
                .appendDictionary("i", "like", "sam", "sung", "samsung", "mobile", "ice", "cream", "man go")
                .build();

        Dictionary userDictionary = Dictionary.builder()
                .appendDictionary("i", "like", "sam", "sung", "mobile", "icecream", "man go", "mango")
                .build();

        WordSegmenter wordSegmenter = WordSegmenter.builder()
        ...
        List<String> result = wordSegmenter.participle(sentence, WordSegmenter.SearchMode.ONLY_PUBLIC);
        println(sentence, result);

        sentence = "ilikeicecreamandmango";
        result = wordSegmenter.participle(sentence, WordSegmenter.SearchMode.ONLY_PUBLIC);
        println(sentence, result);
        ...
        result = wordSegmenter.participle(sentence, WordSegmenter.SearchMode.ONLY_USER);
        println(sentence, result);
        ...
        sentence = "ilikesamsungmobile";
        result = wordSegmenter.participle(sentence, WordSegmenter.SearchMode.ALL);
        println(sentence, result);
